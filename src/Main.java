...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("*************"); // for making the output more readable

        // 1. new loop for listing all Floor exercises
        for (int i = 0; i < exercisesList.size(); i++){
            if (exercisesList.get(i).position == false){
                exercisesList.get(i).printFormat();
                System.out.println();
            }
        }
        ...
        // 2. new loop for listing all Floor exercises which take more than a minute
        for (int i = 0; i < exercisesList.size(); i++){
            if (exercisesList.get(i).position == false){
                if (exercisesList.get(i).duration > 60){
                    exercisesList.get(i).printFormat();
                    System.out.println();
                }
            }
